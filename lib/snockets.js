...
(function() {
  ...
  module.exports = Snockets = (function() {
    ...
    Snockets.prototype.getConcatenation = function(filePath, flags, callback) {
      ...
      return this.updateDirectives(filePath, flags, function(err, graphChanged) {
        var ast, chain, code, concatenation, e, link, result, toplevel, _i, _len, _ref1, _ref2, _ref3;
        ...
        try {
          if ((_ref1 = _this.concatCache[filePath]) != null ? _ref1.data : void 0) {
            ...
            ast = _this.concatCache[filePath].ast;
            if (!flags.minify) {
            ...
            for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
              link = _ref2[_i];
              _this.compileFile(link);
              code = _this.cache[link].js.toString('utf8');
            ...
            concatenation = toplevel.print_to_string({
              beautify: true,
              semicolons: false,
              comments: true
            });
            ...
            _this.concatCache[filePath].ast = ast = toplevel;
          }
        } catch (_error) {
          e = _error;
          if (callback) {
  ...
  minify = function(ast) {
    ...
    compressed_ast = ast.transform(uglify.Compressor({
      unused: false,
      side_effects: false
    }));
